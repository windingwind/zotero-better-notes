...
单击它，PDF 项目下将创建一个带有此批注的新笔记，且带有注释的tag标签。
...
按住Ctrl，单击笔记链接，链接的笔记将显示在预览区域（右侧 ➡️）。
...
如果快速插入引文无效，则需要在首选项设置里面，需要将导出的格式设置为citation style，而非export format!

![citationstyle](./image/README/citationstyle.png)

### 3.4 插入当前子笔记到主笔记并实时更新
...
点击主笔记区域右上角的“⬆️ 导出”按钮，或者文件菜单>>导出主笔记。选择要导出的格式，比如 MarkDown。
