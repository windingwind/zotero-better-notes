...
| ExportMDFileContent    | For processing Markdown file content when exporting. See [Markdown Flavor Compatibility](markdown-flavor-compatibility.md) for recipes (Obsidian wiki links, callouts, …). | noteItem, mdContent                                           |
